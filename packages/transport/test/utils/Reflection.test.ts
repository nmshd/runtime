...
import {
    ...
    MessageSigned,
    Relationship,
    RelationshipAcceptanceContentCipher,
    RelationshipAcceptanceContentSigned,
    RelationshipAcceptanceContentWrapper,
...
const transportClassNames: string[] = [
    ...
    `${RelationshipAcceptanceContentCipher.name}@1`,
    `${RelationshipAcceptanceContentWrapper.name}@1`,
    `${RelationshipAcceptanceContentSigned.name}@1`,
