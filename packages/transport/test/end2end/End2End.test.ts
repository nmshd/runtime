...
describe("RelationshipTest: Accept", function () {
    ...
    test("should create new relationship between two accounts", async function () {
        ...
        expect(request.templateId.toString()).toStrictEqual(templateTo.id.toString());
        ...
        expect(pendingRelationship.templateId.toString()).toStrictEqual(templateTo.id.toString());
...
describe("RelationshipTest: Revoke", function () {
    ...
    test("should revoke a relationship between two accounts", async function () {
        ...
        expect(request.templateId.toString()).toStrictEqual(templateRequestor.id.toString());
        expect(request.status).toStrictEqual(RelationshipStatus.Pending);
        ...
        expect(pendingRelationship.templateId.toString()).toStrictEqual(templateRequestor.id.toString());
