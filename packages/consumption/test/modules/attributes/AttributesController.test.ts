...
describe("AttributesController", function () {
    ...
    describe("change AttributeForwardingDetails of Attributes", function () {
        ...
        test("should allow to add AttributeForwardingDetails to an OwnRelationshipAttribute", async function () {
            ...
            const isForwarded = await consumptionController.attributes.isAttributeForwardedToPeer(forwardedOwnRelationshipAttribute, peerAddress);
            expect(isForwarded).toBe(true);
        });
        ...
        test("should allow to add AttributeForwardingDetails to a PeerRelationshipAttribute", async function () {
            ...
            const isForwarded = await consumptionController.attributes.isAttributeForwardedToPeer(forwardedPeerRelationshipAttribute, peerAddress);
            expect(isForwarded).toBe(true);
        });
