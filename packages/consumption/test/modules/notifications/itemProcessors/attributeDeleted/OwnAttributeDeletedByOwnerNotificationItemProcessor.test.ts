...
describe("OwnAttributeDeletedByOwnerNotificationItemProcessor", function () {
    ...
    test("runs all processor methods for a PeerIdentityAttribute", async function () {
        ...
        expect(updatedAttribute.deletionInfo!.deletionStatus).toStrictEqual(ReceivedAttributeDeletionStatus.DeletedByEmitter);
        ...
        expect(databaseAttribute.deletionInfo!.deletionStatus).toStrictEqual(ReceivedAttributeDeletionStatus.DeletedByEmitter);
    ...
    test("runs all processor methods for an Attribute that is to be deleted", async function () {
        ...
        expect(attributeAfterProcessing.deletionInfo!.deletionStatus).toStrictEqual(ReceivedAttributeDeletionStatus.ToBeDeleted);
        ...
        expect(databaseAttribute.deletionInfo!.deletionStatus).toStrictEqual(ReceivedAttributeDeletionStatus.ToBeDeleted);

        /* Manually trigger and verify rollback. */
        await processor.rollback(notificationItem, notification);
        const attributeAfterRollback = (await consumptionController.attributes.getLocalAttribute(notificationItem.attributeId)) as PeerIdentityAttribute;
        expect(attributeAfterRollback.deletionInfo?.deletionStatus).toStrictEqual(ReceivedAttributeDeletionStatus.ToBeDeleted);
    });
    ...
    test("runs all processor methods for a succeeded Attribute", async function () {
        ...
        expect(updatedPredecessor.deletionInfo!.deletionStatus).toStrictEqual(ReceivedAttributeDeletionStatus.DeletedByEmitter);
