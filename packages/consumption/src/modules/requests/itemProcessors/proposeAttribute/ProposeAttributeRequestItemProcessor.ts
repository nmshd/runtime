...
import { AttributeSucceededEvent, OwnIdentityAttributeSuccessorParams, PeerIdentityAttributeSuccessorParams, ReceivedAttributeDeletionStatus } from "../../../attributes";
