...
import { AbstractAttributeDeletionInfo, AbstractAttributeDeletionInfoJSON, IAbstractAttributeDeletionInfo } from "./deletionInfos";

export interface AbstractAttributeSharingDetailsJSON {
    peer: string;
    sourceReference: string;
    deletionInfo?: AbstractAttributeDeletionInfoJSON;
}
