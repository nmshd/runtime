...
export interface FreeValueFormAcceptResponseItemDVO extends AcceptResponseItemDVO {
...
export interface SelectionFormAcceptResponseItemDVO extends AcceptResponseItemDVO {
