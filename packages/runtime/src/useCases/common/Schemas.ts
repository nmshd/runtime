...
export const CreateCreateVerifiableAttributeRequestItemRequest: any = {
    "$schema": "http://json-schema.org/draft-07/schema#",
    "$ref": "#/definitions/CreateCreateVerifiableAttributeRequestItemRequest",
    "definitions": {
        ...
        "TokenStatusListEntryCreationParameters": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "object",
                    "additionalProperties": false,
                    "description": "StatusListManager is a class that manages a list of statuses with variable bit size."
                }
            },
            "required": [
                "type",
...
export const RevokeAttributeRequest: any = {
    "$schema": "http://json-schema.org/draft-07/schema#",
    "$ref": "#/definitions/RevokeAttributeRequest",
    "definitions": {
...
export const CreateSelfSignedVerifiableAttributeRequest: any = {
    "$schema": "http://json-schema.org/draft-07/schema#",
    "$ref": "#/definitions/CreateSelfSignedVerifiableAttributeRequest",
    "definitions": {
        "CreateSelfSignedVerifiableAttributeRequest": {
            "type": "object",
            "properties": {
                "content": {
                    "$ref": "#/definitions/IdentityAttributeJSON"
