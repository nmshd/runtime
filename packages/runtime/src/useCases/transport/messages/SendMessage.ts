...
import { MailJSON, NotificationJSON, Request, RequestJSON, ResponseWrapperJSON } from "@nmshd/content";
...
export interface SendMessageRequest {
    ...
    content: MailJSON | ResponseWrapperJSON | RequestJSON | NotificationJSON;
