...
describe("PeerIdentityAttributeDVO", () => {
    test("check the Sex", async () => {
        ...
        expect(dvo.peer).toBe(rPeerIdentityAttribute.peerSharingInfo!.peer);
        expect(dvo.sourceReference).toBe(rPeerIdentityAttribute.peerSharingInfo!.sourceReference);
        expect(dvo.deletionStatus).toBe(rPeerIdentityAttribute.peerSharingInfo!.deletionInfo?.deletionStatus);
        expect(dvo.deletionDate).toBe(rPeerIdentityAttribute.peerSharingInfo!.deletionInfo?.deletionDate);
