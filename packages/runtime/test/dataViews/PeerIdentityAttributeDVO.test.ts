...
describe("PeerIdentityAttributeDVO", () => {
    test("check the Sex", async () => {
        ...
        expect(dvo.peer).toBe(rPeerIdentityAttribute.peerSharingDetails!.peer);
        expect(dvo.sourceReference).toBe(rPeerIdentityAttribute.peerSharingDetails!.sourceReference);
        expect(dvo.deletionStatus).toBe(rPeerIdentityAttribute.peerSharingDetails!.deletionInfo?.deletionStatus);
        expect(dvo.deletionDate).toBe(rPeerIdentityAttribute.peerSharingDetails!.deletionInfo?.deletionDate);
