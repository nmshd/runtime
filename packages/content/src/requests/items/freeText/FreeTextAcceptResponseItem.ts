...
export class FreeTextAcceptResponseItem extends AcceptResponseItem implements IFreeTextAcceptResponseItem {
    ...
    public static override from(value: IFreeTextAcceptResponseItem | Omit<FreeTextAcceptResponseItemJSON, "@type"> | FreeTextAcceptResponseItemJSON): FreeTextAcceptResponseItem {
